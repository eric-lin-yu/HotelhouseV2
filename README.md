...
- [x] **客製化 UI**: 開發專屬地圖模式之毛玻璃質感 TabBar。
- [x] **收藏模組**: 完成 CollectionsViewController 之 MVVM 化與 Pure Code 重構。
- [ ] **筆記功能**: 在收藏旅社部分，提供筆記頁面，實作基於 Realm 的個人化旅社備註功能。
- [ ] **關於頁面**: 重構 AboutViewController 並加入清除快取、系統設定等功能。
...
## 👨‍💻 作者
**Eric Lin (林工程師)** - 致力於 Clean Code 與架構設計的實踐者。
